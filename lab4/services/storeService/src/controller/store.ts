...
const getUserOrders = async (
  ...
  // console.log('UID USER ORDERS ', req.headers['UID']);
...
const getUserOrder = async (
  ...
  // console.log('UID USER ORDER ', req.headers['UID']);
  const userUid = String(req.headers['UID']);
...
const makePurchase = async (
  ...
  // console.log('UID PURCHASE ', req.headers['UID']);
  const userUid = String(req.headers['UID']);
...
const warrantyRequest = async (
  ...
  // console.log('UID WARRANTY REQUEST ', req.headers['UID']);
  const userUid = String(req.headers['UID']);
...
const refundOrder = async (
  ...
  // console.log('UID REFUND ORDER ', req.headers['UID']);
  const userUid = String(req.headers['UID']);
